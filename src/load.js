...
(function(win, undefined) {
    "use strict";
    var doc = win.document, domWaiters = [], queue = [], // waiters for the
							    // "head ready"
							    // event
    ...
    isAsync = "async" in doc.createElement("script")
	    || "MozAppearance" in doc.documentElement.style || win.opera, isHeadReady, isDomReady,
    /** * public API ** */
	...
	api.load = function() {
		 ...
		 * If caching is not configured correctly on the server, then
		 * items could load twice !
		 **************************************************************/
    ...
    /*
     * We wait for 300 ms before asset loading starts. for some reason this is
     * needed to make sure assets are cached. Not sure why this happens yet. A
     * case study:
     *
